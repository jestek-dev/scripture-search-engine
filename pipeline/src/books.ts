...
export const BOOKS: readonly Book[] = [
  ...
  // Ordinal alias forms ("1st …", "First …") are DATA rows on each numbered
  // book, deliberately NOT a normalizer rule (P5.2/QR-3 approach (b)): the
  // roman-prefix fold exists twice (engine + pipeline twins), and extending
  // both folders for ordinals would double the drift surface P5.1 guards.
  // Data rows need no code on either side and are reviewable line-by-line.
  {
    id: 9,
    name: "1 Samuel",
    testament: "OT",
    chapterCount: 31,
    abbreviations: ["1 Sam", "1Sam", "I Samuel", "I Sam", "1Sa", "1st Samuel", "First Samuel", "1st Sam"],
  },
  {
    id: 10,
    name: "2 Samuel",
    testament: "OT",
    chapterCount: 24,
    abbreviations: ["2 Sam", "2Sam", "II Samuel", "II Sam", "2Sa", "2nd Samuel", "Second Samuel", "2nd Sam"],
  },
  {
    id: 11,
    name: "1 Kings",
    testament: "OT",
    chapterCount: 22,
    abbreviations: ["1 Kgs", "1Kgs", "I Kings", "I Kgs", "1Ki", "1st Kings", "First Kings", "1st Kgs"],
  },
  {
    id: 12,
    name: "2 Kings",
    testament: "OT",
    chapterCount: 25,
    abbreviations: ["2 Kgs", "2Kgs", "II Kings", "II Kgs", "2Ki", "2nd Kings", "Second Kings", "2nd Kgs"],
  },
  {
    id: 13,
    name: "1 Chronicles",
    testament: "OT",
    chapterCount: 29,
    abbreviations: ["1 Chron", "1Chron", "1 Chr", "1Chr", "I Chronicles", "1st Chronicles", "First Chronicles", "1st Chron"],
  },
  {
    id: 14,
    name: "2 Chronicles",
    testament: "OT",
    chapterCount: 36,
    abbreviations: ["2 Chron", "2Chron", "2 Chr", "2Chr", "II Chronicles", "2nd Chronicles", "Second Chronicles", "2nd Chron"],
  },
  ...
  { id: 18, name: "Job", testament: "OT", chapterCount: 42, abbreviations: ["Jb"] },
  {
    ...
    testament: "OT",
    chapterCount: 150,
    // "Pslam"/"Pslams" (transposed a/l) — curated misspelling rows (P5.2/
    // QR-3 (c), J33 review): unambiguous across all 66 books, not English
    // words, high-frequency typos for the most-searched book.
    abbreviations: ["Psalm", "Ps", "Psa", "Pslm", "Psm", "Pslam", "Pslams"],
  },
  {
    id: 20,
    name: "Proverbs",
  ...
  { id: 45, name: "Romans", testament: "NT", chapterCount: 16, abbreviations: ["Rom", "Rm"] },
  {
    ...
    testament: "NT",
    chapterCount: 16,
    abbreviations: ["1 Cor", "1Cor", "I Corinthians", "I Cor", "1Co", "1st Corinthians", "First Corinthians", "1st Cor"],
  },
  {
    id: 47,
    name: "2 Corinthians",
  ...
  },
  {
    ...
    testament: "NT",
    chapterCount: 6,
    abbreviations: ["1 Tim", "1Tim", "I Timothy", "1Ti", "1st Timothy", "First Timothy", "1st Tim"],
  },
  {
    id: 55,
    name: "2 Timothy",
    testament: "NT",
    chapterCount: 4,
    abbreviations: ["2 Tim", "2Tim", "II Timothy", "2Ti", "2nd Timothy", "Second Timothy", "2nd Tim"],
  },
  ...
  { id: 59, name: "James", testament: "NT", chapterCount: 5, abbreviations: ["Jas", "Jm"] },
  {
    ...
    testament: "NT",
    chapterCount: 5,
    abbreviations: ["1 Pet", "1Pet", "I Peter", "1Pe", "1 Pt", "1st Peter", "First Peter", "1st Pet"],
  },
  {
    id: 61,
    name: "2 Peter",
    testament: "NT",
    chapterCount: 3,
    abbreviations: ["2 Pet", "2Pet", "II Peter", "2Pe", "2 Pt", "2nd Peter", "Second Peter", "2nd Pet"],
  },
  {
    id: 62,
    name: "1 John",
    testament: "NT",
    chapterCount: 5,
    abbreviations: ["1 Jn", "1Jn", "I John", "1Jo", "1st John", "First John", "1st Jn"],
  },
  {
    id: 63,
    name: "2 John",
    testament: "NT",
    chapterCount: 1,
    abbreviations: ["2 Jn", "2Jn", "II John", "2Jo", "2nd John", "Second John", "2nd Jn"],
  },
  {
    id: 64,
    name: "3 John",
    testament: "NT",
    chapterCount: 1,
    abbreviations: ["3 Jn", "3Jn", "III John", "3Jo", "3rd John", "Third John", "3rd Jn"],
  },
